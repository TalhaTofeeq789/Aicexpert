            ...
            <div className={`main-center-content-m-left main-center-content-m-left ${themeSidebarToggle ? "collapsed" : ""}`}>
                <div className="banner-badge bg_image">
                    <div className="inner">
                        ...
                        <p className="dsic">
                            AICEXPERT is the place to create, publish and monetize content using the power of AI. Use the AICEXPERT AI Studio to create amazing generative images, music, and audio.
                        </p>
                ...
                <div className="search__generator mt--50">
                    <h4 className="title color-white-title-home">👋 Welcome, AICEXPERT</h4>
